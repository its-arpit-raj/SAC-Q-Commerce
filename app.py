...
[data-testid="collapsedControl"]{
    ...
    padding:8px 6px!important;z-index:999999!important;
    box-shadow:3px 0 12px rgba(0,0,0,0.6)!important;
}
[data-testid="collapsedControl"] svg{fill:#fff!important;color:#fff!important;opacity:1!important}
[data-testid="collapsedControl"]:hover{background:#06D6A0!important;cursor:pointer!important}
section[data-testid="stSidebar"]>div{background:#0D1B2A!important}
section[data-testid="stSidebar"] p,section[data-testid="stSidebar"] span,
section[data-testid="stSidebar"] label,section[data-testid="stSidebar"] small{color:#7ECECA!important}
...
with st.sidebar:
    ...
    for m in ["SAC Modeler","SAC Story","Smart Predict","SAC Planning"]:
        st.markdown(f"✅ **{m}**")
    st.divider()
    st.caption(f"Zone: {zone_f}")
    st.caption(f"Time: {time_f}")
